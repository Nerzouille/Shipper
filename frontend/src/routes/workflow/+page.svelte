...
<style>
  ...
  .step-counter { font-size: 0.8rem; color: #94a3b8; margin: 0 0 1.25rem; }
  ...
  .dark .step { background: rgba(15, 23, 42, 0.7); border-color: #1e293b; }
  ...
  .step-label { font-size: 0.875rem; font-weight: 500; flex: 1; color: #1e293b; transition: color var(--theme-dur) ease; }
